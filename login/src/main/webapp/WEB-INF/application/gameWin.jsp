...
<html lang="en">
  ...
  <body>
    ...
    <p>Number target is ${gameRecord.numberTarget}</p>
    <p>Point is ${gameRecord.point}</p>
    <div>
      ...
      <form style="float:right; width: 45%; text-align:left"  action="<%=request.getContextPath() + UrlConst.RANKING%>" method="get" >
          <button type="submit" class="btn btn-primary w-50">Ranking</button>
      </form>
    </div>
